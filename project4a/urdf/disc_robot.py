...
def write_urdf_file(robot, file_name):
    with open(file_name, 'w') as f:
        f.write(robot['urdf'])
file_name = 'bad.robot'
robot = load_disc_robot(f'/home/lab2004/project_ws/src/project4/project4/urdf/{file_name}')
l = robot['wheels']['distance']
write_urdf_file(robot,f'/home/lab2004/project_ws/src/project4/project4/urdf/{file_name}.urdf')
